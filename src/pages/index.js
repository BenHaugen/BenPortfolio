...
const DEFAULT_IMAGES = [
    { id: '7', thumbnail: thumb07, caption: <a href="http://sillibi-group.s3-website-us-east-1.amazonaws.com/" target="_blank">Sillibi</a>, description: 'A mobile app, Sillibi was built with Stencil JS components and Ruby on Rails, Sillibi allows users to keep track all of their college courses, assignments and class resumes in one place.'},
